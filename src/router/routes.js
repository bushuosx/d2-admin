...
const frameIn = [
  ...
  // },
  {
    ...
    children: (pre => [
      ...
      { path: 'ksjs/create', name: `${pre}ksjs-create`, component: () => import('@/pages/yljs/ksjs/create'), meta: { ...meta, title: '科室技术维护' } },
      ...
      { path: 'ksjs/list', name: `${pre}ksjs-list`, component: () => import('@/pages/yljs/ksjs/list'), meta: { ...meta, title: '科室技术报表' } },
