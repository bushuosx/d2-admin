...
const frameIn = [
  ...
  },
  {
    ...
    children: (pre => [
      ...
      { path: 'ryjs/:ryjsid', name: `${pre}ryjs-index`, component: () => import('@/pages/yljs/ryjs'), props: true, meta: { ...meta, title: '人员技术详细' } },
      ...
      { path: 'ryjs/listbyks/:ksid', name: `${pre}ryjs-listbyks`, component: () => import('@/pages/yljs/ryjs/listbyks'), props: true, meta: { ...meta, title: '人员技术列表' } },
      { path: 'ryjs/kjsh/:ryjsid', name: `${pre}ryjs-kjsh`, component: () => import('@/pages/yljs/ryjs/kjsh'), props: true, meta: { ...meta, title: '人员技术科级审核' } },
