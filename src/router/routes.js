...
const frameIn = [
    ...
    children: [
      {
        ...
        name: 'index',
        // meta,
        component: () => import('@/pages/yljs/index')
      }
    ]
  },
  {
  ...
  // },
  {
    ...
    children: (pre => [
      ...
      { path: 'ry/listbyjs', name: `${pre}ry-listbyjs`, component: () => import('@/pages/yljs/ry/listbyjs'), props: (route) => ({ tag1: route.params.tag1, tag2: route.params.tag2, ryList: route.params.ryList, showks: route.params.showks }), meta: { ...meta, title: '技术授权人员列表' } },
      ...
      { path: 'js/search', name: `${pre}js-search`, component: () => import('@/pages/yljs/js/search'), props: true, meta: { ...meta, title: '查询本院已授权技术' } },
      { path: 'ks/index/:ksid', name: `${pre}ks-index`, component: () => import('@/pages/yljs/ks'), props: true, meta: { ...meta, title: '科室' } },
      { path: 'ks/js', name: `${pre}ks-js`, component: () => import('@/pages/yljs/ks/js'), meta: { ...meta, title: '科室技术列表' } },
      { path: 'ksjs/create/:ksid', name: `${pre}ksjs-create`, component: () => import('@/pages/yljs/ksjs/create'), props: true, meta: { ...meta, title: '科室技术维护' } },
      { path: 'ks/list', name: `${pre}ks-list`, component: () => import('@/pages/yljs/ks/list'), meta: { ...meta, title: '科室列表' } },
      { path: 'ks/ry/:ksid', name: `${pre}ks-ry`, component: () => import('@/pages/yljs/ks/ry'), props: true, meta: { ...meta, title: '科室人员列表' } },
      { path: 'ksjs/list/:ksid', name: `${pre}ksjs-list`, component: () => import('@/pages/yljs/ksjs/list'), props: true, meta: { ...meta, title: '科室技术报表' } },
      { path: 'ryks/create', name: `${pre}ryks-create`, component: () => import('@/pages/yljs/ryks/create'), meta: { ...meta, title: '入科申请' } },
      { path: 'ryks/edit/:ksid', name: `${pre}ryks-edit`, component: () => import('@/pages/yljs/ryks/edit'), props: true, meta: { ...meta, title: '编辑入科申请' } },
      { path: 'ryks/kjsh/:ksid', name: `${pre}ryks-kjsh`, component: () => import('@/pages/yljs/ryks/kjsh'), props: true, meta: { ...meta, title: '审核入科申请' } },
      { path: 'ryjs/index/:ryjsid', name: `${pre}ryjs-index`, component: () => import('@/pages/yljs/ryjs'), props: true, meta: { ...meta, title: '人员技术详细' } },
      { path: 'ryjs/search', name: `${pre}ryjs-search`, component: () => import('@/pages/yljs/ryjs/search'), meta: { ...meta, title: '人员技术搜索' } },
      { path: 'ryjs/listbyry/:ryid', name: `${pre}ryjs-listbyry`, component: () => import('@/pages/yljs/ryjs/listbyry'), props: true, meta: { ...meta, title: '人员技术列表' } },
      { path: 'ryjs/listbyks/:ksid', name: `${pre}ryjs-listbyks`, component: () => import('@/pages/yljs/ryjs/listbyks'), props: true, meta: { ...meta, title: '科室人员技术列表' } },
      { path: 'ryjs/kjsh/:ksid', name: `${pre}ryjs-kjsh`, component: () => import('@/pages/yljs/ryjs/kjsh'), props: true, meta: { ...meta, title: '人员技术科级审核' } },
      ...
      { path: 'manage/ry/importry', name: `${pre}manage-ry-importry`, component: () => import('@/pages/yljs/manage/ry/importry.vue'), meta: { ...meta, title: '导入员工列表' } },
      { path: 'manage/ry/getemployees', name: `${pre}manage-ry-getemployees`, component: () => import('@/pages/yljs/manage/ry/getemployees.vue'), meta: { ...meta, title: '查询员工' } },
